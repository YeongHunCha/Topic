...
public class CityAdapter extends RecyclerView.Adapter<CityAdapter.ViewHolder> {
    ...
    public CityAdapter(Activity context, ArrayList<String> cityList) {
        this.context = context;
        this.cityList = cityList;
    }

    public void onBindViewHolder(ViewHolder holder, final int position) {
        Glide.with(context).load(R.drawable.paris).centerCrop().into(holder.ivCity);
        ...
        holder.tvCity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                extra = new Bundle();
                intent = new Intent();
                extra.putString("city", cityList.get(position));
